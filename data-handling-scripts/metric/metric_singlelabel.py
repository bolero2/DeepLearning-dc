...
def make_csv(image_path, gt_path, dt_path, gt_coord, gt_coord_type, dt_coord, dt_coord_type, iou_threshold=0.5,
        ...
        for dt_line in dt_line_list:
            ...
            for gt_line in gt_line_list:
                ...
                if iou_val > iou_threshold:
                    val_TP = 1
                    val_FP = 0
                    csv_list1.append([detect_index, conf_score, iou_val, val_TP, val_FP])
                    number_TP += 1
                    toggle = True
                    break
    ...
    for rows in range(len(csv_list1)):
        val_TP = csv_list1[rows][3]
        val_FP = csv_list1[rows][4]
        count_TP += val_TP
        count_FP += val_FP
...
if __name__ == "__main__":
    ...
    gt_path = "/home/bolero/.dc/dl/yolov5-c16//new_endo_dataset/"
    dt_path = "/home/bolero/.dc/dl/yolov5-c16/runs_v5m_1/new_endo/labels/"
    gt_coord = 'ccwh'
    gt_coord_type = 'relat'
    dt_coord = 'ccwh'
    dt_coord_type = 'relat'
    ...
    csv_save_name = f'best_IoU{iou_threshold}-yolov5m_newendo'
    prc_save_name = f'best_IoU{iou_threshold}-yolov5m_newendo'
